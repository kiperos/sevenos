...
#
#usage:
# curl -O https://raw.githubusercontent.com/kiperos/sevenos/master/zipo.sh && chmod +x zipo.sh && ./zipo.sh
...
clear
  ...
  echo ""
cd
curl -O https://raw.githubusercontent.com/kiperos/sevenos/master/axx.7z
}
